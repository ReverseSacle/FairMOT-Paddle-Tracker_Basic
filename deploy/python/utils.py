...
def set_model_dir(model_dir):
    s_model_dir = model_dir
    if not s_model_dir:
        s_model_dir = "../best_model/"
...
def set_video_file(video_file):
    s_video_file = video_file
    if not s_video_file:
        s_video_file = "../video/test.avi"

    return s_video_file

def set_use_device(use_device):
    s_use_device = use_device
    if not set_use_device:
        s_use_gpu = 'cpu'
...
def argsparser():
    ...
    parser.add_argument(
        "--video_file",
        type=str,
        default=set_video_file,
        help="Path of video file, `video_file` or `camera_id` has a highest priority."
    )
    parser.add_argument(
        "--camera_id",
        type=int,
        default= set_camera_id,
        help="device id of camera to predict.")
    parser.add_argument(
        "--threshold", type=float, default=set_threshold, help="Threshold of score.")
    parser.add_argument(
        "--output_dir",
        type=str,
        default=set_output_dir,
